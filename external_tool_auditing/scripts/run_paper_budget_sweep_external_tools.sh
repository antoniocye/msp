...
export OMP_NUM_THREADS="${BENCH_THREADS:-6}"
export MKL_NUM_THREADS="${BENCH_THREADS:-6}"
export OPENBLAS_NUM_THREADS="${BENCH_THREADS:-6}"
export VECLIB_MAXIMUM_THREADS="${BENCH_THREADS:-6}"
export NUMEXPR_NUM_THREADS="${BENCH_THREADS:-6}"
